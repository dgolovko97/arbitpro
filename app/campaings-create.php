            ...
            <form class="form" action="#" id="kt_subscriptions_create_new">
                ...
                <div class="card card-flush pt-3 mb-5 mb-lg-10 shadow-sm">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <!--begin::Table-->
                        <table class="table align-middle table-row-bordered fs-6 fw-bold border border-1 table-rounded gs-2" id="kt_datatable_example_6">
                            <!--begin::Table head-->
                            <thead class="table-dark ">
                            <tr class="text-start fw-bolder fs-7 align-middle text-center text-nowrap">
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <!--begin::Table-->
                <table class="table align-middle table-row-bordered fs-6 fw-bold gy-4 border border-1 table-rounded gs-2 table-striped" id="kt_datatable_example_6">
                    <!--begin::Table head-->
                    <thead class="table-dark ">
