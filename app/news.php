...
<div id="kt_engage_demos" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="explore" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'100%', 'sm': '350px', 'lg': '550pxf'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_engage_demos_toggle" data-kt-drawer-close="#kt_engage_demos_close">
    ...
    <div class="card shadow-none rounded-0 w-100">
        ...
        <div class="card-header" id="kt_engage_demos_header">
            <h3 class="card-title fw-bolder text-gray-700">Фильтры новостей</h3>
            <div class="card-toolbar">
                    ...
                    <div class="form">
                        ...
                        <div class="d-flex align-items-center mb-8">
                            ...
                            <div class="flex-grow-1">
                                <span href="#" class="text-gray-800 fw-bolder fs-6">Показать все</span>
                            </div>
                            <!--end::Description-->
                        </div>
                        <!--end:Item-->
                        ...
                        <div class="d-flex align-items-center mb-8">
                            ...
                            <!--begin::Description-->
                            <div class="flex-grow-1">
                                <span href="#" class="text-gray-800 fw-bolder fs-6">Новые лендинги</span>
                            </div>
                            <!--end::Description-->
                            <span class="badge badge-light-success fs-8 fw-bolder">LP</span>
                        </div>
                        <!--end:Item-->
                        <!--begin::Item-->
                        <div class="d-flex align-items-center mb-8">
                            ...
                            <!--begin::Description-->
                            <div class="flex-grow-1">
                                <span href="#" class="text-gray-800 fw-bolder fs-6">Новые прокладки</span>
                            </div>
                            <!--end::Description-->
                            <span class="badge badge-light-primary fs-8 fw-bolder">TP</span>
                        </div>
                        <!--end:Item-->
                        <!--begin::Item-->
                        <div class="d-flex align-items-center mb-8">
                            ...
                            <!--begin::Description-->
                            <div class="flex-grow-1">
                                <span href="#" class="text-gray-800 fw-bolder fs-6">Изменение ГЕО</span>
                            </div>
                            <!--end::Description-->
                            <span class="badge badge-light-info fs-8 fw-bolder">ГЕО</span>
                        </div>
                        <!--end:Item-->
                        <!--begin::Item-->
                        <div class="d-flex align-items-center mb-8">
                            ...
                            <!--begin::Description-->
                            <div class="flex-grow-1">
                                <span href="#" class="text-gray-800 fw-bolder fs-6">Финансы</span>
                            </div>
                            <!--end::Description-->
                            <span class="badge badge-light-dark fs-8 fw-bolder">$$$</span>
                        </div>
                        <!--end:Item-->
                        <!--begin::Item-->
                        <div class="d-flex align-items-center mb-8">
                            ...
                            <!--begin::Description-->
                            <div class="flex-grow-1">
                                <span href="#" class="text-gray-800 fw-bolder fs-6">Остановка оффера</span>
                            </div>
                            <!--end::Description-->
                            <span class="badge badge-light-warning fs-8 fw-bolder">STOP</span>
                        </div>
                        <!--end:Item-->
                        <!--begin::Item-->
                        <div class="d-flex align-items-center mb-8">
                            ...
                            <!--begin::Description-->
                            <div class="flex-grow-1">
                                <span href="#" class="text-gray-800 fw-bolder fs-6">Новый оффер</span>
                            </div>
                            <!--end::Description-->
                            <span class="badge badge-light-danger fs-8 fw-bolder">NEW!</span>
                        </div>
                        <!--end:Item-->
                        <a href="#" class="btn btn-primary w-100 mb-3"><i class="fas fa-redo fs-4 me-2"></i>Применить</a>
