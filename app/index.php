                                ...
                                <div class="card-body p-0">
                                    <div class="d-flex flex-stack card-p flex-grow-1">
                                        ...
                                        <div class="d-flex flex-column text-end">
                                            ...
                                            <span class="text-muted fw-bold mt-1 text-nowrap">Weekly Income</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-stack card-p flex-grow-1">
                                                            <span class="symbol symbol-50px me-2">
                                                                <span class="symbol-label bg-light-primary">
                                                                    <!--begin::Svg Icon | path: icons/duotune/finance/fin001.svg-->
                                                                    <i class="bi bi-check2-all fs-2x text-primary"></i>
                                                                    <!--<span class="svg-icon svg-icon-2x svg-icon-primary">
                                                                       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
<path d="M10 18C9.7 18 9.5 17.9 9.3 17.7L2.3 10.7C1.9 10.3 1.9 9.7 2.3 9.3C2.7 8.9 3.29999 8.9 3.69999 9.3L10.7 16.3C11.1 16.7 11.1 17.3 10.7 17.7C10.5 17.9 10.3 18 10 18Z" fill="currentColor"/>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3">
                                                    ...
                                                    <span class="menu-title">Excel 2007+</span>
                                                </a>
                                            </div>
                                        </div>
                                        Экспорт
                            ...
                            <table id="datatable_statistic" class="table table-row-bordered gs-2 table-hover">
                                <thead class="table-dark fs-6 px-7 align-middle text-start text-nowrap fw-bolder">
                                    <tr class="">
                                        ...
                                        <th data-bs-toggle="tooltip" data-bs-target="hover" data-bs-placement="top" title="Epc" data-bs-custom-class="tooltip-dark">Epc</th>
                                        <th data-bs-toggle="tooltip" data-bs-target="hover" data-bs-placement="top" title="Epc по уникам" data-bs-custom-class="tooltip-dark">Epc уник</th>
                                        <th data-bs-toggle="tooltip" data-bs-target="hover" data-bs-placement="top" title="Cr" data-bs-custom-class="tooltip-dark">Cr</th>
                                        <th data-bs-toggle="tooltip" data-bs-target="hover" data-bs-placement="top" title="% подтверждённых лидов" data-bs-custom-class="tooltip-dark">Approve</th>
                                        <th data-bs-toggle="tooltip" data-bs-target="hover" data-bs-placement="top" title="% валидного трэша" data-bs-custom-class="tooltip-dark">
                                             <span class="svg-icon svg-icon-2x th-in-thead">
                                                 <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <rect x="0" y="0" width="24" height="24"/>
                                            ...
                                            <span class="th-in-thead">в %</span>
                                            <span class="th-in-responsive">% валидного трэша</span>
                                        </th>
                                        <th data-bs-toggle="tooltip" data-bs-target="hover" data-bs-placement="top" title="Сумма конверсий" data-bs-custom-class="tooltip-dark">
                                            <span class="th-in-thead">&Sigma;</span>
                                            <span class="th-in-responsive">Сумма конверсий</span>
                                        </th>
                                        <th data-bs-toggle="tooltip" data-bs-target="hover" data-bs-placement="top" title="Сумма валидных конверсий" data-bs-custom-class="tooltip-dark">
                                            <span class="th-in-thead">&Sigma; в</span>
                                            <span class="th-in-responsive">Сумма валидных конверсий</span>
                                        </th>
                                        <th data-bs-toggle="tooltip" data-bs-target="hover" data-bs-placement="top" title="Подтверждённые конверсии" data-bs-custom-class="tooltip-dark">
                                            <span class="svg-icon svg-icon-2x th-in-thead">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <span class="th-in-responsive">Подтверждённые конверсии</span>
                                        </th>
                                        <th data-bs-toggle="tooltip" data-bs-target="hover" data-bs-placement="top" title="Конверсии в ожидании" data-bs-custom-class="tooltip-dark">
                                            <span class="svg-icon svg-icon-2x th-in-thead">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <rect x="0" y="0" width="24" height="24"/>
                                            ...
                                            <span class="th-in-responsive">Конверсии в ожидании</span>
                                        </th>
                                        <th data-bs-toggle="tooltip" data-bs-target="hover" data-bs-placement="top" title="Отклонённые конверсии" data-bs-custom-class="tooltip-dark">
                                            <span class="svg-icon  svg-icon-2x th-in-thead">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <span class="th-in-responsive">Отклонённые конверсии</span>
                                        </th>
                                        <th data-bs-toggle="tooltip" data-bs-target="hover" data-bs-placement="top" title="Трэш (фейк) конверсии" data-bs-custom-class="tooltip-dark">
                                            <span class="svg-icon svg-icon-2x th-in-thead">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <rect x="0" y="0" width="24" height="24"/>
                                            ...
                                            <span class="th-in-responsive">Трэш (фейк) конверсии</span>
                                        </th>
                                        <th data-bs-toggle="tooltip" data-bs-target="hover" data-bs-placement="top" title="Подтверждённые финансы" data-bs-custom-class="tooltip-dark">
                                            <span class="svg-icon svg-icon-2x th-in-thead">
                                               <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																	<rect x="0" y="0" width="24" height="24"></rect>
                                            ...
                                            <span class="th-in-responsive">Подтверждённые финансы</span>
                                        </th>
                                        <th data-bs-toggle="tooltip" data-bs-target="hover" data-bs-placement="top" title="Финансы в ожидании" data-bs-custom-class="tooltip-dark">
                                            <span class="svg-icon svg-icon-2x th-in-thead">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <rect x="0" y="0" width="24" height="24"/>
                                            ...
                                            <span class="th-in-responsive">Финансы в ожидании</span>
                                        </th>
                                    </tr>
                                </thead>
                ...
                <div id="" class=" me-n5 pe-5">
                    ...
                    <div class="mb-0">
                        <div class="form">
                            ...
                            <div class="mb-5">
                                <!--begin::Select2-->
                                <select class="form-select form-select-solid" data-control="select2"  data-placeholder="Оффер" multiple="multiple" data-allow-clear="true">
                            ...
                            <div class="mb-5">
                                <!--begin::Select2-->
                                <select class="form-select form-select-solid" data-control="select2" data-placeholder="Поток" data-allow-clear="true">
                                    <option value="1">вариант 1</option>
                                    <option value="2">вариант 2</option>
                                    <option value="3">вариант 3</option>
                                    <option value="4">вариант 4</option>
