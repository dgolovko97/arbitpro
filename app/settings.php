...
<div class="content d-flex flex-column flex-column-fluid pt-0" id="">
    <!--begin::Container-->
                    ...
                    <div id="" class="collapse show">
                        ...
                        <form id="kt_account_profile_details_form" class="form">
                            ...
                            <div class="card-body border-top p-0 p-sm-5">
                                ...
                                <!--begin::Table-->
                                <table id="datatable_domain_parking" class="table table-row-bordered gs-2">
                                    <!--begin::Table head-->
                ...
                <div class="tab-pane card mb-5 mb-xl-10" role="tabpanel" id="tab_postback">
                    ...
                    <div id="" class="collapse show">
                        ...
                        <div class="card-body border-top p-0 p-sm-5">
                            ...
                            <!--begin::Table-->
                            <table id="datatable_postback" class="table table-row-bordered gs-2">
                                <!--begin::Table head-->
                                <thead class="table-dark fs-6 px-7 align-middle text-start text-nowrap fw-bolder">
                                    <tr>
                                        <th class="dtr-control">
                                ...
                                <tr>
                                    <td></td>
                                    <td class="text-nowrap">19.03.2022</td>
                                    <td>example.com</td>
                                    <td>Параметры</td>
                                    <td>Метод</td>
                                    <td>Статус ответа</td>
